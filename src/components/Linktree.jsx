...
export const Linktree = () => {
  return (
    <div id='container' className='flex flex-col justify-center items-center border border-5 p-10 mt-5 lg:ml-80 lg:mr-80 lg:mt-10 lg:mb-10 sm:m-10 md:m-20 rounded-xl w-100 bg-gradient-to-r from-purple-400 to-yellow-200'>
        <div id='container_profile' className='hover:scale-[1.05]'>
            ...
            <h5 id='twitter' className='text-center text-grey-400 font-semibold p-2'>@AlabiAbiodun_O</h5>
            <h6 id='slack' className='hidden text-center text-grey-400 font-semibold'>@alabiabiodun</h6>
        </div>
        <div id='container_links' className='flex flex-col justify-center items-center p-3 m-2 w-100 text-grey-400 font-medium'>
